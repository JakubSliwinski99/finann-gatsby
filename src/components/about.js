    ...
    return(
        <section className={AboutStyle.about} id="about">
            <section>
                ...
                <p>
                    Podstawowym obszarem działalności biura jest kompleksowa obsługa małych i średnich firm
                    w zakresie usług podatkowych, księgowych, rozliczenia z ZUS oraz prowadzenie spraw pracowniczych
                    (kadrowo-płacowych). Udzielamy wsparcia na wszystkich etapach prowadzenia działalności
                    gospodarczej.
                </p>
                <p>
                    Naszą wizytówką jest rzetelność i profesjonalizm. Wieloletnie doświadczenie zawodowe oraz
                    indywidualne podejście do każdego Klienta gwarantuje świadczenie przez nas usług na najwyższym
                    poziomie.
                </p>
                <p>
